<?php
/**
 * Widget API: proin_widget_tag_cloud
 *
 * @package Proin
 * @subpackage Proin
 * @since 1.0
 ...
 * 
 */
class Proin_Widget_Tag_Cloud extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'description' => "Nube de etiquetas para proin" );
		parent::__construct('proin_tag_cloud', 'Proin Tag Cloud', $widget_ops);
	}
	...
	public function widget( $args, $instance ) {
		...
		foreach($tag_cloud as $tag)	echo $tag;
